...
require_once("include/city_variables.php");
...
$layout = new TLayout("export2", "Office1Avenue2", "MobileAvenue2");
$layout->version = 2;
...
$page_layouts["city_export"] = $layout;
...
if( @$_REQUEST["a"] != "" )
{
	...
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["City_ID"] = refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[] = $keys;
		}
	}
