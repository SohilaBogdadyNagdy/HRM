...
$layout = new TLayout("print", "Office1Avenue2", "MobileAvenue2");
$layout->version = 2;
...
$page_layouts["doctors_print"] = $layout;
...
$layout = new TLayout("masterprint", "Office1Avenue2", "MobileAvenue2");
$layout->version = 2;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "doctors" );
