...
require_once("include/Allemployeeaccoedingtogrouptype_variables.php");
...
$layout = new TLayout("report_print", "Office1Avenue2", "MobileAvenue2");
$layout->version = 2;
...
$page_layouts["Allemployeeaccoedingtogrouptype_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Allemployeeaccoedingtogrouptype.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Allemployeeaccoedingtogrouptype.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("Opject_Group_fieldheader", true);
$xt->assign("Name_fieldheader", true);
$xt->assign("Deprtment_fieldheader", true);
$xt->assign("out_code_fieldheader", true);
