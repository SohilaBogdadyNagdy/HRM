...
require_once("include/AcadmicReport_variables.php");
...
$page_layouts["AcadmicReport_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=AcadmicReport.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=AcadmicReport.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("COUNT_Name__fieldheader", true);
$xt->assign("Now_Acadmic_fieldheader", true);
$xt->assign("Main_work_place_fieldheader", true);
